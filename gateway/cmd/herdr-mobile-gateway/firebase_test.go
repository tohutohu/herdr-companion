...
func TestFirebase設定は同じプロジェクトのAndroidアプリだけを取り込む(t *testing.T) {
	...
	android := []byte(`{"project_info":{"project_id":"test","project_number":"123"},"client":[{"client_info":{"mobilesdk_app_id":"1:123:android:abc","android_client_info":{"package_name":"com.tohutohu.herdrcompanion"}},"api_key":[{"current_key":"client-api-key"}]}]}`)
